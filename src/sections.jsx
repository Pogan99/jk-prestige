...
function WhoWeAre() {
  ...
  return (
    <>
    <style>{`@media(max-width:860px){.jk-who-we-are{grid-template-columns:1fr!important}.jk-who-we-are>*{grid-column:1/-1!important;min-width:0!important}.jk-who-we-are .display{font-size:clamp(28px,8vw,42px)!important;hyphens:none!important;word-break:normal!important}}`}</style>
    <section className="section" style={{background:'var(--bg-primary)', overflow:'hidden'}}>
      <div className="wrap jk-who-we-are" style={{display:'grid', gridTemplateColumns:'1.15fr 1fr', gap:'clamp(32px,5vw,96px)', alignItems:'stretch', maxWidth:'100%'}}>
        <Reveal>
...
function SubcontractingBand() {
  ...
  return (
    <>
    <style>{`@media(max-width:860px){.jk-sub-band{grid-template-columns:1fr!important}.jk-sub-band>*{grid-column:1/-1!important;min-width:0!important}.jk-sub-band .display{font-size:clamp(26px,7vw,38px)!important;hyphens:none!important;word-break:normal!important}}`}</style>
...
function TestimonialBlock() {
  ...
  return (
    <>
    <style>{`@media(max-width:860px){.jk-testimonial-grid{grid-template-columns:1fr!important;padding:48px 18px!important}.jk-testimonial-grid>*{grid-column:1/-1!important;min-width:0!important}.jk-testimonial-h2{font-size:clamp(32px,9vw,48px)!important;hyphens:none!important;word-break:normal!important}}`}</style>
